...
# Korean i18n blocks for the served dashboard/detail bundles. These are the only
# definitions: the superseded first copies that used to sit above were removed once it
# turned out Python was silently discarding them at import time. They are patched into
# the embedded APP_JS/DETAIL_JS fallbacks by _dashboard_js()/_detail_js(); the primary
# source of truth for what browsers receive is vcb_alt/web_assets/.
APP_KO_I18N = """  ko: {
